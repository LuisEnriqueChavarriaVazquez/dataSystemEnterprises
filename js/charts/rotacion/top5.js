...
var valores = localStorage.getItem('rotacionEmpresaGraph').split(",").map(Number);
const top5_rotacion = document.getElementById("top5_rotacion");
...
const data_top5_rotacion = {
    labels: top5Labels,
    datasets: [{
      axis: 'bar',
      label: 'Top 5 índices de rotación',
      data:top5Valores,
      fill: true,
  ...
  new Chart(top5_rotacion, {
    type:'bar',
    data: data_top5_rotacion,
    options: {
      indexAxis:'y',
    }
  });