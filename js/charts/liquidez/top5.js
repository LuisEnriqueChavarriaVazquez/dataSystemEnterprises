...
var valores = localStorage.getItem('liquidezEmpresaGraph').split(",").map(Number);
const top5_liquidez = document.getElementById("top5_liquidez");
...
const data_top5_liquidez = {
    labels: top5Labels,
    datasets: [{
      axis: 'bar',
      label: 'Top 5 índices de liquidez',
      data:top5Valores,
      fill: true,
  ...
  new Chart(top5_liquidez, {
    type:'bar',
    data: data_top5_liquidez,
    options: {
      indexAxis:'y',
    }
  });